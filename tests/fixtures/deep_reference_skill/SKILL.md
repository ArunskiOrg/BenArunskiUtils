...
The agent reading this file is sent to [the guide](reference/guide.md), which does not answer the question either: it forwards to a third file. That second hop is the violation.
